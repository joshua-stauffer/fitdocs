...
Actual load: 210 -- 6 of 6 logged workouts scored under threshold; 70% of target.
...
Actual load: at least 200 -- 1 of 2 logged workouts scored under threshold, 1 unscored, 1 excluded (scored under other); at least 80% of target.
...
- [w2-excluded-log](../workouts/w2-excluded-log.md) -- 2026-02-12, Run, load 150 under other (excluded from the sum)
...
Actual load: 60 -- 1 of 1 logged workout scored under threshold; no target.
