...
MOVING_THRESHOLD_CHOICE: Final[FitdocsChoice] = FitdocsChoice(
    ...
    "treating a sample above it (or a cumulative-distance increase across "
    "the pair, for a speed-less channel) as 'moving' keeps brief "
    "stationary noise from being counted as movement without also "
    "discarding genuine slow walking. That reasoning is why fitdocs keeps "
